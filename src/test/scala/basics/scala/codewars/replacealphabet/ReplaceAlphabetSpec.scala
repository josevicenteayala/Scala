...
class ReplaceAlphabetSpec extends FunSuite {

  test("Replace string 'primera prueba' ") {
    val text = "primera prueba"
    assert(ReplaceAlphabet.alphabetPosition(text).equals("16 18 9 13 5 18 1 16 18 21 5 2 1") )
  }

  test("Replace string 'The sunset sets at twelve o' clock.' ") {
  ...
  test("Replace string 'uvqewpx3ue?i3m?nn' ") {
   ...
   */
  test("Replace string '3xnxhyphzk/iwf6'g(w?aef/scu/no' ") {
  ...
  test("Replace string 'primera prueba' V2") {
    val text = "primera prueba"
    assert(ReplaceAlphabet.alphabetPositionV2(text).equals("16 18 9 13 5 18 1 16 18 21 5 2 1") )
  }

  test("Replace string 'The sunset sets at twelve o' clock.' V2") {
    val text = "The sunset sets at twelve o' clock."
  ...
  test("Replace string 'uvqewpx3ue?i3m?nn' V2") {
    val text = "uvqewpx3ue?i3m?nn"
